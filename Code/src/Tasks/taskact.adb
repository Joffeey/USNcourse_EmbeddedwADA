...
package body TaskAct is
   ...
   begin
      case Direction is
         ...
         when RotateRight =>
            DriveWheel(w => (p.LF_IN3,p.LF_IN4,p.LF_ENB, True, False, 512));
            DriveWheel(w => (p.LB_IN1,p.LB_IN2,p.LB_ENA, True, False, 512));  
            DriveWheel(w => (p.RF_IN1,p.RF_IN2,p.RF_ENA, False, True, 512)); 
            DriveWheel(w => (p.RB_IN3,p.RB_IN4,p.RB_ENB, False, True, 512)); 
         when RotateLeft =>
            DriveWheel(w => (p.LF_IN3,p.LF_IN4,p.LF_ENB, False, True, 512));
            DriveWheel(w => (p.LB_IN1,p.LB_IN2,p.LB_ENA, False, True, 512));  
            DriveWheel(w => (p.RF_IN1,p.RF_IN2,p.RF_ENA, True, False, 512)); 
            DriveWheel(w => (p.RB_IN3,p.RB_IN4,p.RB_ENB, True, False, 512)); 
      end case;
   end Drive;
